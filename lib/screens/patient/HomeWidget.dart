...
List? list;
  ...
  Widget build(BuildContext context) {
    ...
    User _user=User.fromJson(jsonDecode(snapshot.data.toString()));
            return Container(
                          ...
                          children: [
                            Row(
                              ...
                              children: [
                                ...
                                IconButton(onPressed: (){}, icon: FaIcon(FontAwesomeIcons.arrowAltCircleRight))
                              ],
                            ),
                            SizedBox(height: 10,),
                            Row(
