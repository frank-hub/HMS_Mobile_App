...
class _RegisterState extends State<Register> {
  ...
  final TextEditingController _MnameController = new TextEditingController();
    ...
    if (res.statusCode == 200) {
      ...
      if (user_role == "doctor") {
        Navigator.push(context,
            new MaterialPageRoute(builder: (context) => HomeScreenDoctor()));
      } else {
        Navigator.push(context,
            new MaterialPageRoute(builder: (context) => PatientHome()));
      }
    } else {
